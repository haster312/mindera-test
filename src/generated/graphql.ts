...
export type ProductQueryQuery = { products: { edges: Array<{ node: { id: string, title: string, description: string, availableForSale: boolean, images: { edges: Array<{ node: { src: any, altText?: string | null } }> }, variants: { edges: Array<{ node: { price: { amount: any, currencyCode: CurrencyCode }, compareAtPrice?: { amount: any, currencyCode: CurrencyCode } | null } }> } } }>, pageInfo: { hasNextPage: boolean, endCursor?: string | null } } };
